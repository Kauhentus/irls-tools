...
exports.IRLSElement = exports.Box = void 0;
...
class Box {
    ...
    compute_constrained_position(other_boxes) {
        ...
        const constraints = [
            // x-axis alignment
            ...other_boxes.map(box => [0.5, (main_box, other_boxes) => {
            ...
            // }],
            // no overlap
            [100.0, (main_box, other_boxes) => {
                    return other_boxes
                        .map(box => {
                        const cost_A = main_box.overlaps(box) ? 100 : 0; // discrete overlaps yes or no
...
exports.Box = Box;
let IRLSElement = class IRLSElement extends lit_1.LitElement {
    constructor() {
        super(...arguments);
...
exports.IRLSElement = IRLSElement;
__decorate([
    (0, decorators_js_1.query)('#base')
], IRLSElement.prototype, "canvas", void 0);
exports.IRLSElement = IRLSElement = __decorate([
    (0, decorators_js_1.customElement)('irls-element')
], IRLSElement);
